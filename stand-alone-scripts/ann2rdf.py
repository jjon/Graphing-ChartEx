...
def ann2rdf(g, annfile, charter_id):
    ...
    for line in annfile:
        ...
        if line[0] == "A": # for example: A2	Implied-SiteRef T17 genitive
            ...
            ## OK, this is fine for experimental purposes; however, we should be adding the attribute as a property to a single entity, rather than giving it an additional type. Also, report bug in brat: dclick on string, and dialog offers the attribute list, whether or not the entity can take one. Check latest builds.
