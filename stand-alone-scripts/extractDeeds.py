#!/usr/bin/env python
# -*-coding: utf-8-*-
## Deeds has no punctuation at all, no need to translate bullets
...
for line in f:
    ...
    if m:
        ...
        txt = file("/Users/jjc/Documents/ChartEx/initialSets/deeds-docs/markup-set/deeds-" + md[0] + ".txt", mode='w')
        ann = file("/Users/jjc/Documents/ChartEx/initialSets/deeds-docs/markup-set/deeds-" + md[0] + ".ann", mode='w')
